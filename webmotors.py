...
if __name__ == "__main__":
    print("🚀 Robô de Prospecção de Motos - Webmotors")
    print("⏲️  Configurado para rodar automaticamente a cada 5 minutos.")
    print("Prepara o café, Renato! O robô está trabalhando para você.\n")

    while True:
        buscar_motos_webmotors()

        # Intervalo de 5 minutos (300 segundos)
        print(f"\n⏳ Aguardando 5 minutos para a próxima checagem...")
        time.sleep(300)